      ...
      @foreach ($indivs as $indiv)
          <div class="col-md-4">
            <div class="card mb-4 box-shadow">
              <img class="card-img-top" src="{{asset($indiv->profilepic)}}" alt="Card image cap">
              <div class="card-body">
                <h6> {{$indiv->name}} </h6>
                  <p class="card-text">{{$indiv->email}}</p>
                  <p class="card-text">{{$indiv->introduction}}</p>
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <small class="text-muted">{{ $indiv->created_at->format('Y-m-d H:i:s') }}</small>
                </div>
              </div>
            </div>
          </div>
